...
def get_image_feature_vectors():
  ...
  for filename in glob.glob('/home/anm/fashionWebScraping/images_scraped/full/*.jpg'): #assuming gif
    i = i + 1
    ...
    out_path = os.path.join('/home/anm/fashionWebScraping/images_scraped/feature-vectors/', outfile_name)
