...
def match_id(filename):
  with open('/home/anm/fashionWebScraping/jsonFiles/image_data.json') as json_file:
...
def cluster():
  ...
  allfiles = glob.glob('/home/anm/fashionWebScraping/images_scraped/feature-vectors/*.npz')
